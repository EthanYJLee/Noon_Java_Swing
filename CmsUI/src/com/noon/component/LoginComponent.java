...
public class LoginComponent extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/noon/icon/biglogo.png"))); // NOI18N

        jRadioButton1.setText("임원");

        jRadioButton2.setText("아르바이트");

        jRadioButton3.setText("관리자");
