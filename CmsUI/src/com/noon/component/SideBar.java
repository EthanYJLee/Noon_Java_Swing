...
public class SideBar extends javax.swing.JPanel {
    ...
    private void init() {
        ...
        listCategory1.addItem(new Model_Category("3", "가게 현황", Model_Category.CategoryType.CATEGORY));
...
//        listCategory1.addItem(new Model_Category("", "발주 게시판", Model_Category.CategoryType.SUBCATEGORY));
    }
