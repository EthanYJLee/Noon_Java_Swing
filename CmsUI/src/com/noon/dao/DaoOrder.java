...
public class DaoOrder {
	...
	public HashMap<String,Integer> countOrderNum7Day() {
		...
		String whereStatement = "select count(orderno) , paydate from noon.order ";
		String whereStatement2 = "where paydate between date_add(curdate(),interval -7 day) and curdate() group by paydate";
	...
	public ArrayList<DtoOrder> searchAction(){
		...
		String whereStatement = "select o.paydate , o.set_menu_name, sum(o.quantity) , count(o.orderno) ,count(c.completetime) ";
		String whereStatement2 = "from noon.order o ,complete c where o.orderno = c.order_orderno and c.completetime is not null ";
		String whereStatement3 = "group by (o.paydate and o.set_menu_name)";
