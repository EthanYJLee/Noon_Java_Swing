...
public class AppPanel05_Order01Shop extends JPanel {
	
	private AppPanel05_Order02Time appPanel05_Order02Time = new AppPanel05_Order02Time();
		...
		if (lblBtnSelect == null) {
			...
			lblBtnSelect.addMouseListener(new MouseAdapter() {
				...
				public void mouseClicked(MouseEvent e) {
					setVisible(false);
					AppMain.frame.getContentPane().add(appPanel05_Order02Time);
//					AppMain.frame.add(appPanel06_Order02Time);
				}
			});
