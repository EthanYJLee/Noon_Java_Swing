...
CREATE TABLE IF NOT EXISTS `noon`.`complete` (
  ...
  PRIMARY KEY (`completeno`, `staff_id`, `shop_shopcode`, `order_orderno`, `order_member_id`, `order_set_setno`, `order_set_menu_name`, `order_shop_shopcode`, `order_staff_id`),
  ...
  INDEX `fk_complete_order1_idx` (`order_orderno` ASC, `order_member_id` ASC, `order_set_setno` ASC, `order_set_menu_name` ASC, `order_shop_shopcode` ASC, `order_staff_id` ASC) VISIBLE,
