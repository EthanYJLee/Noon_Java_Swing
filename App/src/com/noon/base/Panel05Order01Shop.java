...
public class Panel05Order01Shop extends JPanel {
	...
	private JLabel getLblNewLabel_01() {
		if (lblNewLabel_01 == null) {
			lblNewLabel_01 = new JLabel("Order");
	...
	private JButton getLblBtnTabOrder() {
		if (lblBtnTabOrder == null) {
			...
			lblBtnTabOrder
					.setIcon(new ImageIcon("./src/com/noon/app/tabbar_order.png"));
	...
	private JButton getLblBtnTabMypage() {
		if (lblBtnTabMypage == null) {
			...
			lblBtnTabMypage
					.setIcon(new ImageIcon("./src/com/noon/app/tabbar_mypage.png"));
	...
	private JComboBox getCbConditionQuery() {
		if (cbConditionQuery == null) {
			...
			cbConditionQuery.setModel(new DefaultComboBoxModel(new String[] { "선택", "매장명", "도/광역시", "군/구/시", "동" }));
	...
	private JLabel getLblBtnShopSearch() {
		if (lblBtnShopSearch == null) {
			...
			lblBtnShopSearch
					.setIcon(new ImageIcon("./src/com/noon/app/iconSearch3.png"));
		}
	...
	private JLabel getLblPn2Background() {
		if (lblPn2Background == null) {
			...
			lblPn2Background.setIcon(
					new ImageIcon("./src/com/noon/app/shopandtime_back1.png"));
	...
	private JLabel getLblNewLabel_02_1() {
		if (lblNewLabel_02_1 == null) {
			lblNewLabel_02_1 = new JLabel("방문하실 시간을 선택해주세요 !");
	...
	private JLabel getLblLeftQuentity() {
		if (lblLeftQuentity == null) {
			lblLeftQuentity = new JLabel("판매가능 잔수 : 잔");
			lblLeftQuentity.setHorizontalAlignment(SwingConstants.CENTER);
			lblLeftQuentity.setForeground(new Color(16, 16, 16));
	...
	private JLabel getLblNewLabel_1() {
		if (lblNewLabel == null) {
			...
			lblNewLabel.setIcon(
					new ImageIcon("./src/com/noon/app/shopandtime_back3.png"));
	...
	private JLabel getLblNewLabel_1_1() {
		if (lblNewLabel_1 == null) {
			...
			lblNewLabel_1.setBounds(14, 572, 345, 34);
		}
		...
		if (lblBtnSelect == null) {
			...
			lblBtnSelect.addMouseListener(new MouseAdapter() {
				...
				public void mouseReleased(MouseEvent e) {
					lblBtnSelect.setIcon(
							new ImageIcon("./src/com/noon/app/btn_select.png"));
				}
			});
			lblBtnSelect.setIcon(new ImageIcon("./src/com/noon/app/btn_select.png"));
