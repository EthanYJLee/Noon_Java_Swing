...
public class Panel02SignUp extends JPanel {
	...
	private JLabel getLblNewLabel_2() {
		if (lblNewLabel_2 == null) {
			...
			lblNewLabel_2.setIcon(new ImageIcon("./src/com/noon/app/btn_ID_overlap.png"));
			...
			lblBtnSingup.addMouseListener(new MouseAdapter() {
				...
				public void mousePressed(MouseEvent e) {
					lblBtnSingup.setIcon(
							new ImageIcon("./src/com/noon/app/btn_signup2_C.png"));
				}

				@Override
				public void mouseReleased(MouseEvent e) {
					lblBtnSingup
							.setIcon(new ImageIcon("./src/com/noon/app/btn_signup2.png"));
				}
			});
			lblBtnSingup.setIcon(new ImageIcon("./src/com/noon/app/btn_signup2.png"));
